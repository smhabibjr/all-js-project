...
$("#toggle-btn5").click(function(){
  $(this).toggleClass("fa-plus fa-times");
  $("#toggle-project-block5").slideToggle();
});

function bmi(weight, height){
  var squereHeight = Math.pow(height, 2);
  var calculateBmi = Math.round(weight / squereHeight);
  return calculateBmi;
}
document.querySelector("#btnBmiCalculator").addEventListener("click", function(){
